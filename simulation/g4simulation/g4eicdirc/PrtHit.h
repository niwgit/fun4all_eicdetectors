...
class PrtHit : public PHG4Hitv1
{
 public:
  ...
  Double_t GetBarHitTime() { return fBarHitTime; }
  ...
  void SetAngleTrack(Double_t val) { fAngleTrack = val; }
  void SetBarHitTime(Double_t val) { fBarHitTime = val; }
